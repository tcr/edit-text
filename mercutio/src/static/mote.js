...
function init($elem, editorID) {
    ...
    // Button shelf
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()('<div class="button-shelf">')
        .appendTo($elem.prev());
    // theme
...
function onmessage(event) {
    ...
    if (parse.Update) {
        ...
        __WEBPACK_IMPORTED_MODULE_2_jquery___default()('.button-shelf').each((_, x) => {
