...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_bootstrap__ = __webpack_require__(23);
...
`;
    new __WEBPACK_IMPORTED_MODULE_3__parent__["a" /* default */]();
}
...
class Editor {
    constructor(elem, editorID) {
        ...
        $('<button>Monkey</button>')
            ...
            .on('click', function () {
            monkey = !monkey;
            editor.nativeCommand(__WEBPACK_IMPORTED_MODULE_0__commands__["d" /* MonkeyCommand */](monkey));
    ...
    onSyncMessage(event) {
        ...
        if ('Monkey' in event.data) {
            ...
            editor.nativeCommand(__WEBPACK_IMPORTED_MODULE_0__commands__["d" /* MonkeyCommand */](true));
        }
    }
}
