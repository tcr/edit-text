...
/* WEBPACK VAR INJECTION */(function(setImmediate) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_dist_css_bootstrap_min_css__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__multi__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__interop__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_bootstrap__ = __webpack_require__(31);
...
`;
    ...
    if (!WASM) {
        ...
        __WEBPACK_IMPORTED_MODULE_4__interop__["a" /* instantiate */](function (data) {
            ...
            setImmediate(() => {
                // Websocket port
                let full_id = window.location.pathname.match(/^\/?([^\/]+)/)[1];
                let url = (window.location.protocol.match(/^https/) ? 'wss://' : 'ws://') +
                    (window.location.host.match(/localhost/) ?
                        window.location.host.replace(/:\d+$|$/, ':8001') + '/$/ws/' + full_id :
                        window.location.host + '/$/ws/' + full_id);
...
class Editor {
    constructor(elem, editorID) {
        ...
        new __WEBPACK_IMPORTED_MODULE_2_clipboard___default.a('#save-markdown', {
        ...
        $('<button>X-Ray</button>')
            ...
            const settings = __WEBPACK_IMPORTED_MODULE_1__hashstate__["a" /* default */].get();
            ...
            __WEBPACK_IMPORTED_MODULE_1__hashstate__["a" /* default */].set(settings);
        });
        // Client Id.
        $('<b>Client: <kbd>' + editorID + '</kbd></b>')
            .appendTo($('#local-buttons'));
        // theme
        if (__WEBPACK_IMPORTED_MODULE_1__hashstate__["a" /* default */].get().has(`${editorID}-theme-block`)) {
        ...
        $(document).on('keypress', (e) => {
            ...
            editor.nativeCommand(__WEBPACK_IMPORTED_MODULE_0__commands__["b" /* CharacterCommand */](e.charCode));
            e.preventDefault();
        });
