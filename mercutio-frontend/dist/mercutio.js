...
/******/ 				}
/******/ 				script.src = __webpack_require__.p + "" + chunkId + ".mercutio.js";
...
Object.defineProperty(exports, "__esModule", { value: true });
// Global CSS
__webpack_require__(/*! ../styles/mercutio.scss */ "./styles/mercutio.scss");
const Clipboard = __webpack_require__(/*! clipboard */ "./node_modules/clipboard/lib/clipboard.js");
...
class LocalButtons extends React.Component {
    ...
    onSaveMarkdown() {
        this.setState(Object.assign({}, this.state, { copying: true }));
        setTimeout((() => {
            this.setState(Object.assign({}, this.state, { copying: false }));
        }).bind(this), 2000);
    }
    onXray() {
        // TODO
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement("button", { id: "save-markdown", onClick: () => this.onSaveMarkdown(), style: { width: this.state.copying ? this.state.width : 'auto', }, ref: (el) => { el && (this.state.width = el.offsetWidth + 'px'); } }, this.state.copying ? `Copied!` : `Save Markdown`),
            React.createElement("button", { id: "xray", onClick: () => this.onXray() }, "X-Ray"),
            React.createElement("b", null,
                "Client: ",
                React.createElement("kbd", null, this.props.editorID))));
    }
}
...
class EditorFrame extends React.Component {
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement("div", { id: "toolbar" },
                React.createElement("a", { href: "https://github.com/tcr/edit-text", id: "logo" }, "edit-text"),
                React.createElement(NativeButtons, { buttons: this.state.buttons, editor: this }),
                ",",
                React.createElement(LocalButtons, { editorID: this.state.editorID })),
            React.createElement(editor_1.Editor, { network: this.props.network, KEY_WHITELIST: this.KEY_WHITELIST, content: this.state.body, editorID: this.state.editorID }),
            ","));
    }
    ...
    onNativeMessage(parse) {
        ...
        if (parse.Init) {
            ...
            editor.KEY_WHITELIST.splice.apply(editor.KEY_WHITELIST, [0, 0].concat(parse.Controls.keys.map(x => ({
                keyCode: x[0],
                metaKey: x[1],
                shiftKey: x[2],
            }))));
...
function start() {
    let network = CONFIG.wasm ? new network_1.WasmNetwork() : new network_1.ProxyNetwork();
...
let imports = {};
imports['env'] = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"env\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

            const bytes = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"fs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).readFileSync('mercutio_bg.wasm');
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: getWasmModule */
...
/* harmony import */ var _bindgen_mercutio_bg_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bindgen/mercutio_bg.js */ "./src/bindgen/mercutio_bg.js");
/* harmony import */ var _bindgen_mercutio_bg_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_bindgen_mercutio_bg_js__WEBPACK_IMPORTED_MODULE_1__);
...
function getWasmModule() {
    return _bindgen_mercutio_bg_js__WEBPACK_IMPORTED_MODULE_1__["booted"]
    .then(() => __webpack_require__.e(/*! import() */ 0).then(function() { var module = __webpack_require__(/*! ./bindgen/mercutio */ "./src/bindgen/mercutio.js"); return typeof module === "object" && module && module.__esModule ? module : Object.assign({/* fake namespace object */}, typeof module === "object" && module, { "default": module }); }));
}

// Launch the application.

_app__WEBPACK_IMPORTED_MODULE_2__["start"]();
...
exports.ProxyNetwork = ProxyNetwork;
let sendCommandToJSList = [];
function sendCommandToJS(msg) {
    sendCommandToJSList.forEach(handler => handler(msg));
}
exports.sendCommandToJS = sendCommandToJS;
class WasmNetwork {
    constructor() {
