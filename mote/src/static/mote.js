...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootbox__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bootbox___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_bootbox__);



function newElem(attrs) {
    return modifyElem(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div>'), attrs);
}
    ...
    for (var i = 0; i < el.DocGroup[1].length; i++) {
        if (Object.keys(el.DocGroup[1][i])[0] == 'DocChars') {
            for (var j = 0; j < el.DocGroup[1][i].DocChars.length; j++) {
                h.append(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('<span>').text(el.DocGroup[1][i].DocChars[j]));
            }
        }
        else {
...
function getActive() {
    var a = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.active');
    return a[0] ? a : null;
}
function getTarget() {
    var a = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.active');
...
function clearActive() {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).find('.active').removeClass('active');
}
...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.op = function (d, a) {
        ...
        setTimeout(function () {
            ...
            __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax('/api/confirm', {
...
var ops_a = init(m1);
var ops_b = init(m2);
__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.get('/api/hello', function (data) {
    m1.empty().append(load(data));
    m2.empty().append(load(data));
});
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#action-reset').on('click', function () {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax('/api/reset', {
        contentType: 'application/json',
        type: 'POST',
    })
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#action-sync').on('click', function () {
    var packet = [
        ops_a,
        ops_b
    ];
    console.log('PACKET', packet);
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax('/api/sync', {
        data: JSON.stringify(packet),
        contentType: 'application/json',
        type: 'POST',
    })
